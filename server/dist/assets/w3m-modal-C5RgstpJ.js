const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BCjWSW-A.js","assets/index-D8ociH5K.js","assets/index-X4u-sDsZ.css"])))=>i.map(i=>d[i]);
  ...
  async handleClose() {
    ...
    if (this.isSiweEnabled) {
      const { SIWEController } = await __vitePreload(async () => {
        const { SIWEController: SIWEController2 } = await import("./index-BCjWSW-A.js");
