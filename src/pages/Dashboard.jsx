        ...
        <Card sx={{
          ...
          >
            {[
              ...
              { icon: <CustomSVGIcons.Trophy size={120} animated={true} />, title: 'Team Growth Wallet', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.teamLevelStake), subtitle: 'Growth Wallet Balance', color: 'secondary.main' },
        ...
        <Card sx={{
          ...
          >
            {[
              ...
              { icon: <CustomSVGIcons.TrendingUp size={120} animated={true} />, title: 'Growth Earn', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.growthEarn), subtitle: 'From Growth System', color: 'success.main' },
