    ...
    <Box sx={{
      ...
      >
        ...
        <Card sx={{
          ...
          >
            {[
              { icon: <CustomSVGIcons.Users size={120} animated={true} />, title: 'My Direct', value: isLoading ? <LoadingSkeleton height={40} width={80} /> : formatNumber(mlmData.directTeam), subtitle: 'Direct Referrals', color: 'primary.main' },
              { icon: <CustomSVGIcons.Star size={120} animated={true} />, title: 'Strong Teams', value: isLoading ? <LoadingSkeleton height={40} width={80} /> : formatNumber(mlmData.strongTeam), subtitle: 'Active Strong Teams', color: 'secondary.main' },
        ...
        <Card sx={{
          ...
          >
            {[
              { icon: <CustomSVGIcons.TrendingUp size={120} animated={true} />, title: 'Total In', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.totalIn), subtitle: 'Total Investments', color: 'success.main' },
              { icon: <CustomSVGIcons.DollarSign size={120} animated={true} />, title: 'Total Out', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.totalOut), subtitle: 'Total Withdrawals', color: 'info.main' },
              { icon: <CustomSVGIcons.Wallet size={120} animated={true} />, title: 'Active Portfolio', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.activePortfolio), subtitle: 'Current Investment Value', color: 'primary.main' },
              { icon: <CustomSVGIcons.Trophy size={120} animated={true} />, title: 'Team Growth Wallet', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.teamLevelStake-mlmData.growthFuels), subtitle: 'Growth Wallet Balance', color: 'secondary.main' },
        ...
        <Card sx={{
          ...
          >
            {[
              { icon: <CustomSVGIcons.Users size={120} animated={true} />, title: 'Referral Earn', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.referralEarn), subtitle: 'From Direct Referrals', color: 'primary.main' },
              { icon: <CustomSVGIcons.BarChart3 size={120} animated={true} />, title: 'Level Earn', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.levelEarn), subtitle: 'From Team Levels', color: 'info.main' },
              { icon: <CustomSVGIcons.TrendingUp size={120} animated={true} />, title: 'Growth Earn', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.growthFuels), subtitle: 'From Growth System', color: 'success.main' },
              { icon: <CustomSVGIcons.Trophy size={120} animated={true} />, title: 'Leader Earn', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.leaderEarn), subtitle: 'From Leadership', color: 'warning.main' },
              { icon: <CustomSVGIcons.BarChart3 size={120} animated={true} />, title: 'Development Earn', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.developmentEarn), subtitle: 'From Development', color: 'info.main' },
              { icon: <CustomSVGIcons.Users size={120} animated={true} />, title: 'Team Growth', value: isLoading ? <LoadingSkeleton height={40} width={100} /> : formatCurrency(mlmData.teamGrowthWallet), subtitle: 'Team Growth Wallet', color: 'secondary.main' },
            ].map((card, index) => (
              <Grid
                item
                xs={6}
